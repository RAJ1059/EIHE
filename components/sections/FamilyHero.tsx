...
const caseStatus = [
  { label: "Petition & evidence filed", status: "Complete" as const },
  { label: "Biometrics appointment", status: "Scheduled" as const },
  { label: "Interview preparation", status: "Pending" as const },
        ...
        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-white/70 px-4 py-1.5 text-xs font-semibold tracking-[0.2em] text-sage uppercase shadow-sm backdrop-blur-sm">
              Dossios Legal Services &middot; Family-Based Immigration
            </span>
          </Reveal>

          <Reveal delay={0.08}>
            <h1 className="mt-6 text-5xl leading-[1.05] font-semibold tracking-tight text-ink sm:text-6xl">
              Keeping families together, made visible.
            </h1>
          </Reveal>

          <Reveal delay={0.16}>
            <p className="mt-6 max-w-md text-lg leading-relaxed text-ink/80">
              Licensed attorneys lead every family case — from the
              marriage-based petition to the naturalization interview. Our
              secure case platform gives you a clear, real-time view of
              where things stand.
            </p>
          </Reveal>
        ...
        >
          ...
          <div className="relative rounded-2xl border border-ink/5 bg-white p-5 shadow-[0_20px_60px_-15px_rgba(32,116,96,0.35)] transition-transform duration-500 ease-out hover:-translate-y-1">
            <div className="flex items-center justify-between text-xs text-ink/60">
              <span className="font-medium">CASE &middot; DOS-2026-0842</span>
