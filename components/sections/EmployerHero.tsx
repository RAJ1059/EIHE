...
const caseStatus = [
  { label: "Attorney strategy review", status: "Complete" as const },
  { label: "Evidence & document package", status: "In progress" as const },
  { label: "Final legal review", status: "Pending" as const },
  { label: "USCIS filing", status: "Pending" as const },
];
        ...
        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-white/70 px-4 py-1.5 text-xs font-semibold tracking-[0.2em] text-sage uppercase shadow-sm backdrop-blur-sm">
              Dossios Legal Services &middot; Employer-Sponsored Immigration
            </span>
          </Reveal>

          <Reveal delay={0.08}>
            <h1 className="mt-6 text-5xl leading-[1.05] font-semibold tracking-tight text-ink sm:text-6xl">
              Global talent, made visible.
            </h1>
          </Reveal>

          <Reveal delay={0.16}>
            <p className="mt-6 max-w-md text-lg leading-relaxed text-ink/80">
              Licensed attorneys lead every sponsorship case — H-1B, L-1,
              O-1, and beyond. Our secure case platform gives your HR team
              a clear, real-time view of where every employee&rsquo;s case
              stands.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.24}>
            <div className="mt-8 flex flex-wrap items-center gap-6">
              <Button href="/contact">Start a Case</Button>
